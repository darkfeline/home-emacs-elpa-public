...
With prefix ARG, enable Global Obsidian mode if ARG is positive; otherwise,
disable it.
...
Obsidian mode is enabled in all buffers where `obsidian-enable-minor-mode' would
do it.
