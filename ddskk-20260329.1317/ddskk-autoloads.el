...
(register-definition-prefixes "skk" '("abort-" "backward-kill-sentence" "exit-minibuffer" "keyboard-quit" "newline" "next-line" "picture-mode-exit" "previous-line" "skk-" "undo"))


;;; Generated autoloads from skk-abbrev.el

(autoload 'skk-abbrev-search "skk-abbrev")
(register-definition-prefixes "skk-abbrev" '("skk-completion-original"))
...
(register-definition-prefixes "skk-dcomp" '("abort-minibuffers" "keyboard-quit" "skk-" "vip"))
...
(fn DIR)" t)
(add-hook 'before-init-hook (lambda nil (eval-after-load "font-lock" '(set 'lisp-el-font-lock-keywords-2 (nconc (list (list (concat "(\\(\\(skk-\\)?def\\(" "\\(un-cond\\|subst-cond\\|advice\\|" "macro-maybe\\|alias-maybe\\|un-maybe\\)\\|" "\\(var\\|localvar\\)" "\\)\\)\\>" "[ 	'(]*" "\\(\\sw+\\)?") '(1 font-lock-keyword-face) '(6 (cond ((match-beginning 4) font-lock-function-name-face) ((match-beginning 5) font-lock-variable-name-face)) nil t))) (list (list (concat "(" (regexp-opt '("skk-save-point" "skk-with-point-move" "skk-loop-for-buffers") t) "\\>") '(1 font-lock-keyword-face))) (list (list "(\\(skk-error\\)\\>" '(1 font-lock-warning-face))) (symbol-value 'lisp-el-font-lock-keywords-2)))) (put 'skk-deflocalvar 'doc-string-elt 3)))
(register-definition-prefixes "skk-develop" '("skk-"))
...
(register-definition-prefixes "skk-emacs" '("skk-" "tooltip-hide"))
...
(register-definition-prefixes "skk-hint" '("abort-recursive-edit" "keyboard-quit" "skk-"))
...
(fn &rest ARGS)" t)
(defconst skk-isearch-really-early-advice (lambda nil (define-advice isearch-message-prefix (:around (oldfun &optional ellipsis nonincremental) skk-isearch-ad) (let ((current-input-method (unless (and (boundp 'skk-isearch-switch) skk-isearch-switch) current-input-method))) (funcall oldfun ellipsis nonincremental))) (define-advice isearch-toggle-input-method (:around (oldfun) skk-isearch-ad) (cond ((string-match "^japanese-skk" (format "%s" default-input-method)) (let ((skk-isearch-initial-mode-when-skk-mode-disabled 'latin)) (skk-isearch-mode-setup) (skk-isearch-skk-mode))) ((null default-input-method) (funcall oldfun) (when (string-match "^japanese-skk" (format "%s" default-input-method)) (let ((skk-isearch-initial-mode-when-skk-mode-disabled 'latin)) (skk-isearch-mode-setup)) (deactivate-input-method))) (t (funcall oldfun))))))
(define-key isearch-mode-map [(control \\)] 'isearch-toggle-input-method)
(register-definition-prefixes "skk-isearch" '("isearch-" "skk-isearch-"))
...
(register-definition-prefixes "skk-jisx0213" '("skk-jisx0213-"))
...
(register-definition-prefixes "skk-macs" '("cancel-undo-boundary" "event-to-character" "skk-"))
...
(fn STR)")
(register-definition-prefixes "skk-num" '("add-number-grouping" "skk-"))
...
(register-definition-prefixes "skk-show-mode" '("skk-"))


;;; Generated autoloads from skk-sticky.el

(register-definition-prefixes "skk-sticky" '("keyboard-quit" "skk-"))
...
(register-definition-prefixes "skk-study" '("skk-"))
...
(register-definition-prefixes "skk-viper" '("skk-viper-" "viper-read-string-with-history"))

;;; End of scraped data
